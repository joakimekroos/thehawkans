        ...
        <div className="row">
          <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div className="thehawkans-ultrawidetext">
                <p className="spreadspan"><span className="emphasis">Billy Idol</span><span>Rebel Yell</span></p>
                <p className="spreadspan"><span className="emphasis">Joan Jett</span><span>I Love Rock and Roll</span></p>
                <p className="spreadspan"><span className="emphasis">The Black Keys</span><span>Lonely Boy</span></p>
                <p className="spreadspan"><span className="emphasis">Survivor</span><span>Eye of the Tiger</span></p>
                <p className="spreadspan"><span className="emphasis">Cameo</span><span>Word Up</span></p>
                <p className="spreadspan"><span className="emphasis">Midnight Oil</span><span>Beds are burning</span></p>
                <p className="spreadspan"><span className="emphasis">Neljä baritonia</span><span>Popmusiikkia</span></p>
                <p className="spreadspan"><span className="emphasis">Alphaville</span><span>Big in Japan</span></p>
                <p className="spreadspan"><span className="emphasis">Kenny Logins</span><span>Danger Zone</span></p>
                <p className="spreadspan"><span className="emphasis">Dingo</span><span>Levoton tuhkimo</span></p>
                <p className="spreadspan"><span className="emphasis">Pelle Miljoona</span><span>Tahdon rakastella sinua</span></p>
                <p className="spreadspan"><span className="emphasis">Roxette</span><span>Sleeping in My Car</span></p>
                <p className="spreadspan"><span className="emphasis">The Cranberries</span><span>Zombie</span></p>
                <p className="spreadspan"><span className="emphasis">Avicii</span><span>Hey brother</span></p>
                <p className="spreadspan"><span className="emphasis">Pink Floyd</span><span>The Wall 1&2</span></p>
            </div>
          </div>
        </div>
      </>
