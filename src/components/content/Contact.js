        ...
        <div className="row">
          ...
          <div className="col-md-6">
            ...
            <p>
              ...
              <a
                href="//facebook.com/thehawkans"
                target="_blank"
                rel="noopener noreferrer"
              >
                facebook.com/thehawkans
              </a>
            </p>
            <p>
              <span className="emphasis">soundcloud: </span>
              <a
                href="//soundcloud.com/thehawkans"
                target="_blank"
                rel="noopener noreferrer"
              >
                soundcloud.com/thehawkans
              </a>
            </p>
            <p>
              <span className="emphasis">spotify: </span>
              <a
                href="//open.spotify.com/artist/1sz1l9exwoVnqDkrYvyLIu"
                target="_blank"
                rel="noopener noreferrer"
              >
                The Hawkans on spotify
              </a>
            </p>
          </div>
        </div>
